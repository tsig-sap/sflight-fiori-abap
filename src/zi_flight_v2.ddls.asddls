...
define view ZI_FLIGHT_V2
  ...
  association [1..*] to ZI_BOOKING_V2        as _Book           on  $projection.Airline      = _Book.Airline
                                                                and $projection.FlightNumber = _Book.FlightNumber
                                                                and $projection.FlightDate   = _Book.FlightDate
  association [1..*] to ZI_TICKET_V2         as _Ticket         on  $projection.Airline      = _Ticket.Airline
                                                                and $projection.FlightNumber = _Ticket.FlightNumber
                                                                and $projection.FlightDate   = _Ticket.FlightDate
  association [1..1] to ZI_FLIGHTSCHEDULE_V2 as _FlightSchedule on  $projection.Airline      = _FlightSchedule.Airline
