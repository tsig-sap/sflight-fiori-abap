...
public section.
  ...
  types:
    begin of TS_ZI_BOOKING_V2TYPE.
      include type ZI_BOOKING_V2.
  types:
    end of TS_ZI_BOOKING_V2TYPE .
  types:
   TT_ZI_BOOKING_V2TYPE type standard table of TS_ZI_BOOKING_V2TYPE .
  types:
    begin of TS_ZI_FLIGHTSCHEDULE_V2TYPE.
      include type ZI_FLIGHTSCHEDULE_V2.
  types:
    end of TS_ZI_FLIGHTSCHEDULE_V2TYPE .
  types:
   TT_ZI_FLIGHTSCHEDULE_V2TYPE type standard table of TS_ZI_FLIGHTSCHEDULE_V2TYPE .
  types:
    begin of TS_ZI_FLIGHT_V2TYPE.
      include type ZI_FLIGHT_V2.
  types:
    end of TS_ZI_FLIGHT_V2TYPE .
  types:
   TT_ZI_FLIGHT_V2TYPE type standard table of TS_ZI_FLIGHT_V2TYPE .
  types:
    begin of TS_ZI_TICKET_V2TYPE.
      include type ZI_TICKET_V2.
  types:
    end of TS_ZI_TICKET_V2TYPE .
  types:
   TT_ZI_TICKET_V2TYPE type standard table of TS_ZI_TICKET_V2TYPE .

  constants GC_I_CURRENCYTYPE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'I_CurrencyType' ##NO_TEXT.
  constants GC_ZI_BOOKING_V2TYPE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZI_BOOKING_V2Type' ##NO_TEXT.
  constants GC_ZI_FLIGHTSCHEDULE_V2TYPE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZI_FLIGHTSCHEDULE_V2Type' ##NO_TEXT.
  constants GC_ZI_FLIGHT_V2TYPE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZI_FLIGHT_V2Type' ##NO_TEXT.
  constants GC_ZI_TICKET_V2TYPE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZI_TICKET_V2Type' ##NO_TEXT.
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20230211002556'.                  "#EC NOTEXT
...
*&---------------------------------------------------------------------*
*    @@TYPE_SWITCH:
    CONSTANTS: co_gen_date_time TYPE timestamp VALUE '20230211002557'.
    TRY.
  ...
  method IF_SADL_GW_MODEL_EXPOSURE_DATA~GET_MODEL_EXPOSURE.
    CONSTANTS: co_gen_timestamp TYPE timestamp VALUE '20230211002557'.
    DATA(lv_sadl_xml) =
